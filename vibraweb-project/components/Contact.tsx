            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="orcamento">{t('contact.subjectOptions.orcamento')}</option>
                  <option value="duvida">{t('contact.subjectOptions.duvida')}</option>
                  <option value="suporte">{t('contact.subjectOptions.suporte')}</option>
                  <option value="outro">{t('contact.subjectOptions.outro')}</option>
                </select>
              </div>
